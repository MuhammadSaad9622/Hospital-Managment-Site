        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr.Asghar Ali</h4>
          ...
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr.Daniyal Shahid</h4>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr. Asad Gouri</h4>
          ...
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr. Fahad</h4>
          ...
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr. Ahmed Ali</h4>
